...
(function () {
    ...
    $(document).ready(function () {
        var links = [
            ...
            {
                name: 'Steam',
                link: 'https://steamcommunity.com/profiles/76561198141922101'
            },
                
            {
                name: 'clip',
                link: 'https://streamable.com/3483w5'
            },
            {
                name: 'clip2',
                link: 'https://streamable.com/prqcyo'
            },
            {
                name: 'clip3',
        ...
        $.getJSON('https://api.ipgeolocation.io/ipgeo?apiKey=1785ed53312f42c7b5ef89f65c3faa1a', function (data) {
            ...
            writeLine(["Authenticating...", "Granting access to <span style='font-size: 14px; color: #06d;'>[unknown]</span>..."], 30, function () {
                ...
                writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Welcome back, <i style='color: #0f0'>" +  ((data.ip) ? data.ip : usernames[Math.floor(Math.random()*usernames.length)]) 
                    ...
                    writeLine(["<i style='color: #F62459'>Mr.Bang $$$</i>"], 120, 500, function () {
